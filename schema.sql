...
INSERT OR IGNORE INTO products (id, slug, name, sub_title, price_range, category, short_description, in_stock, sort_order) VALUES
  ...
  ('prod-branded-units', 'branded-units', 'Branded Sauna Units', 'Authorized Distributor · NEWGENSAUNA · AXISSAUNA', 'Wholesale pricing', 'sauna-control', 'Authorized distributor of premium infrared sauna brands with full warranty support.', 1, 3),
