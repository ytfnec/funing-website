    ...
    <section className="px-page py-[clamp(60px,8vw,100px)] bg-cream">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="bg-card border border-[rgba(23,23,23,0.06)] rounded-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-card border border-[rgba(23,23,23,0.1)] rounded-md text-ink placeholder-[rgba(23,23,23,0.3)] focus:outline-none focus:border-[var(--amber)] resize-none"
                  />
                </div>
              </div>
            </>
          ...
          {step === 2 && (
            <>
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-card border rounded-md text-ink focus:outline-none focus:border-[var(--amber)] ${fieldErrors.name ? 'border-red-400/60' : 'border-[rgba(23,23,23,0.1)]'}`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-card border rounded-md text-ink focus:outline-none focus:border-[var(--amber)] ${fieldErrors.email ? 'border-red-400/60' : 'border-[rgba(23,23,23,0.1)]'}`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-card border border-[rgba(23,23,23,0.1)] rounded-md text-ink focus:outline-none focus:border-[var(--amber)]"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-card border border-[rgba(23,23,23,0.1)] rounded-md text-ink placeholder-[rgba(23,23,23,0.3)] focus:outline-none focus:border-[var(--amber)]"
                    />
                  </div>
                </div>
                <div>
                ...
                {/* Review */}
                <div className="mt-6 p-4 bg-card border border-[rgba(23,23,23,0.06)] rounded-md space-y-2">
          ...
          {/* Navigation */}
          <div className="flex justify-between mt-10 pt-6 border-t border-[rgba(23,23,23,0.06)]">
            {step > 0 ? (
