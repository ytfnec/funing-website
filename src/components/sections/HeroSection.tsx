  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* When image is set, use lighter overlay (40%) so image is visible.
            When no image, use dark overlay (95%) for gradient-only look. */}
        <div
          className="absolute inset-0 bg-gradient-to-br from-gray-900 via-teal-900 to-gray-900"
          style={{ opacity: heroBgImage ? 0.4 : 0.95 }}
        />
        {/* Circuit pattern overlay - hide when image is set */}
        {!heroBgImage && (
        ...
        {/* Animated glow orbs - hide when image is set */}
        {!heroBgImage && (
          <>
