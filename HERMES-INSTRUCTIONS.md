...
| 3 自动化验收 | ✅ | ① 17 条公开路由（/、/about、/accessories、/contact、/cookies、/elevate、/news、/oem、/privacy、/products、/quote、/resources、/terms、/thank-you、/admin/login、/sitemap.xml、/robots.txt）全部 **HTTP 200**；② 3 条 API（/api/products、/api/news、/api/products/sauna-controllers）均返回 `Cache-Control: public, s-maxage=60, stale-while-revalidate=300`；③ 首页 JSON-LD 含 `Organization`/`PostalAddress`/`WebSite`，产品详情含 `Product`/`Offer`/`Brand`/`Organization`/`PostalAddress`/`WebSite`；`/api/news` 返回 `{"articles":[]}`（空数组→新闻详情 NewsArticle 转人工项，发布文章后验证）；④ sitemap.xml 含 17 条 loc（首页、/news、4 产品详情均在列）；robots.txt 含 `Disallow: /admin/`、`Disallow: /api/`、`Sitemap: https://fnec.net/sitemap.xml` ✅ |
